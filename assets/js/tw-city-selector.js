    ...
    function (i, t, n) {
            ...
            if (
              (function () {
                ...
                for (
                  ...
                  if (
                    !(
                      (t && -1 === t.indexOf(this.data.counties[s])) ||
                      (n && -1 !== n.indexOf(this.data.counties[s]))
                    )
                  ) {
                    var e = new Option(
                      this.data.counties[s],
                      this.data.counties[s]
                    );
      ...
      function c() {
        ...
        for (
          ...
          if (
            !(
              (n && -1 === n.indexOf(this.data.districts[i][0][o])) ||
              (s && -1 !== s.indexOf(this.data.districts[i][0][o]))
            )
          ) {
            var a = new Option(
              this.data.districts[i][0][o],
              this.data.districts[i][0][o]
            );
      ...
      function l() {
        ...
        n.initEvent("change", !0, !0),
          i && ((this.elCounty.value = i), this.elCounty.dispatchEvent(n)),
          t && ((this.elDistrict.value = t), this.elDistrict.dispatchEvent(n));
      }
